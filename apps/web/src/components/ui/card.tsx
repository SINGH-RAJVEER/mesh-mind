...
export const CardHeader = (props: CardProps) => {
  ...
  return (
    <div
      className={cn("flex flex-col space-y-1.5 p-6", split.class)}
      {...rest}
    />
  );
};
...
export const CardTitle = (props: CardProps) => {
  ...
  return (
    <div
      className={cn("font-semibold leading-none tracking-tight", split.class)}
      {...rest}
    />
  );
};
...
export const CardDescription = (props: CardProps) => {
  ...
  return (
    <div
      className={cn("text-sm text-muted-foreground", split.class)}
      {...rest}
    />
  );
};
...
export const CardFooter = (props: CardProps) => {
  const [split, rest] = splitProps(props, ["class"]);
  return (
    <div className={cn("flex items-center p-6 pt-0", split.class)} {...rest} />
  );
};
